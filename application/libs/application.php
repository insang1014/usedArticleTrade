...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (file_exists(APPPATH.'controller/' . $this->controller . '.php')) {
            require APPPATH.'controller/' . $this->controller . '.php';
        ...
        if($cancontroll === false) echo "<!DOCTYPE html><html><head><meta charset='utf-8'></head><body><h1>잘못된 접근입니다.</h1></body></html>";
    }
}